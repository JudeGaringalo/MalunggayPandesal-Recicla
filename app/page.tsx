      ...
      <main className="relative bg-white text-[#4A4A4A] font-sans">
        ...
        <section className="relative w-full min-h-screen overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
            ...
            <div
              className="absolute top-[50vh] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1150px] h-[1150px] rounded-[50%] pointer-events-none z-[5]"
              style={{
        ...
        <section className="relative z-10 w-full">
          <div className="relative w-full flex items-center justify-center overflow-hidden">
            <img
              ...
              className="w-[110%] max-w-none h-auto drop-shadow-xl unzoomable"
            />
          ...
          <div className="flex flex-col md:flex-row overflow-hidden rounded-[40px] shadow-2xl border border-gray-100">
            <div className="w-full md:w-1/2 flex flex-col">
              <div className="bg-[#81915A] py-8 px-10 flex flex-col items-center justify-center text-center gap-4 border-b border-white">
                <img src="/images/Frame 59.png" alt="AI Icon" className="w-26 h-26 object-contain unzoomable" />
              ...
              <div className="bg-[#455130] py-8 px-10 flex flex-col items-center justify-center text-center gap-4 border-b border-white">
                <img src="/images/Frame 60.png" alt="Valuation Icon" className="w-26 h-26 object-contain unzoomable" />
              ...
              <div className="bg-[#3D4829] py-8 px-10 flex flex-col items-center justify-center text-center gap-4 border-b border-white">
                <img src="/images/Frame 61.png" alt="Routing Icon" className="w-26 h-26 object-contain unzoomable" />
              ...
              <div className="bg-[#353D22] py-8 px-10 flex flex-col items-center justify-center text-center gap-4">
                <img src="/images/Frame 62.png" alt="Web Icon" className="w-26 h-26 object-contain unzoomable" />
        ...
        >
          <div className="sticky-box w-full md:w-5/12 self-start md:sticky md:top-40 h-auto">
            <div className="w-full py-10 md:py-0">
              ...
              <h2 className="text-4xl md:text-7xl font-bold leading-[1.1] text-[#4A4A4A] tracking-tighter mb-8">
          ...
          <div className="w-full md:w-7/12 flex flex-col gap-32 md:pb-[10vh]">
            {[
              ...
              <div key={idx} className="reveal-up group">
                <div className="aspect-[4/3] bg-gray-100 overflow-hidden rounded-[30px] mb-8 relative cursor-pointer shadow-lg">
                ...
                <div className="flex gap-8 items-start border-b border-gray-100 pb-8">
                  <div className="text-4xl font-bold text-[#7C8D58]">{step.num}</div>
                  <div>
                    <h3 className="text-3xl font-bold mb-4 text-[#4A4A4A]">{step.title}</h3>
                    <p className="text-gray-500 font-light text-lg leading-relaxed">{step.desc}</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-8">
              {[
                ...
                <div key={idx} className="flex flex-col items-center text-center group">
                  <div className="w-48 h-48 md:w-56 md:h-56 bg-[#D9D9D9] rounded-full mb-6 overflow-hidden relative shadow-lg">
                  ...
                  <p className="text-white/90 text-lg font-light">{member.role}</p>
                </div>
              ))}
            </div>
          </div>
