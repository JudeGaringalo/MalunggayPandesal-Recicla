...
/>
        ...
        <section className="relative z-10 container mx-auto px-4 md:px-6 py-12 md:py-32 max-w-6xl">
          {/* Forced flex-row to match web view on mobile */}
          <div className="flex flex-row overflow-hidden rounded-[20px] md:rounded-[40px] shadow-2xl border border-gray-100">
        ...
        {/* --- HOW IT WORKS --- */}
        <section
          className="max-w-[90rem] mx-auto px-4 sm:px-6 md:px-12 py-10 md:py-32 flex flex-row gap-4 sm:gap-12 md:gap-20 relative items-start perspective-[1000px]"
        >
        ...
        <section className="relative z-20 bg-[#76864C] py-10 md:py-32 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
          <div className="container mx-auto px-2 sm:px-6">
            <h2 className="text-white text-2xl sm:text-4xl md:text-6xl font-bold text-center mb-6 md:mb-20 tracking-tight">
              Meet Our Team
            </h2>
        ...
        <section className="relative z-10 mt-8 md:mt-24 py-10 md:py-32 bg-white overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 text-center mb-4 md:mb-12">
            <h2 className="text-[12px] sm:text-xl md:text-4xl font-bold text-[#4A4A4A] tracking-[0.5px] md:tracking-[1.5px]">
