...
// --- THE RESULT CARD COMPONENT (This is what went missing!) ---
const ScanResultCard = ({ itemData }: { itemData: any }) => {
  ...
  // Dynamic colors based on the PDF requirements for Toxic vs Safe items
  ...
  return (
    <div className="w-full h-full flex-1 bg-white shadow-sm flex flex-col overflow-hidden">
      ...
      <div className="p-6 md:p-8 flex flex-col pb-6 bg-white">
        ...
        {/* Hazard Alert / Handling Instructions */}
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 leading-relaxed font-medium">
            {isHazard 
              ...
              : `Please ensure the ${match.className.toLowerCase()} is clean and sorted properly before routing it to the circular economy.`}
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Link href="/" className="flex-1 text-center bg-[#E8E8E8] hover:bg-[#D8D8D8] transition-colors text-gray-700 font-semibold py-3 px-4 rounded-xl text-sm shadow-sm">
            Capture New Photo
          </Link>
        </div>
      </div>
      ...
      <div className="w-full flex-1 min-h-[200px] bg-gray-200 relative overflow-hidden rounded-br-2xl"> 
        <div className="absolute inset-0 bg-blue-50/50 flex items-center justify-center">
          <img src="/images/map-placeholder.png" alt="Map View" className="w-full h-full object-cover" />
        </div>
      </div>
              ...
              <div className="w-full lg:w-[45%] flex flex-col items-center justify-center relative border-gray-200 rounded-tl-2xl rounded-bl-2xl shadow-sm overflow-hidden min-h-[40vh] bg-black">
                ...
                {isAnalyzing && (
                   <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-sm text-white">
                      ...
                      <p className="font-semibold tracking-widest uppercase text-xs animate-pulse">Gemini is Analyzing...</p>
                   </div>
                )}
              </div>
